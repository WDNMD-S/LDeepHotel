...
public class HomeAccountController {
	 ...
	 * @return
	 */
	@RequestMapping(value="/book_cancel",method=RequestMethod.GET)
	public ModelAndView bookCancel(ModelAndView model,Long id){
	...
	public Map<String,String> updatePwdAct(String oldPassword,String newPassword,HttpServletRequest request){
		...
		if(newPassword.equals(loginedAccount.getPassword())){
			retMap.put("type", "error");
			retMap.put("msg", "新密码不能与原密码相同！");
			return retMap;
		}
