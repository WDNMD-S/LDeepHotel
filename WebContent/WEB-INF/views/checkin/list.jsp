	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'roomId',title:'房间',width:100,sortable:true,formatter:function(value,row,index){
			...
			{ field:'createTime',title:'预定时间',width:150,sortable:true,formatter:function(value,row,index){
				return format(value);
			}},
		...
		$('#show-order-dialog').dialog({
            ...
            buttons: [{
                ...
                handler: function(){
            		...
            		$("#add-checkinPrice").val($("#search-roomType option[value='"+selectedOrder.roomTypeId+"']").attr('price'));
